...
def specificity(result, reference):
    ...
    """
    result = numpy.atleast_1d(bool(result))
    reference = numpy.atleast_1d(bool(reference.any()))
...
def main(path_pred=r'C:\Users\yvona\Documents\NPU_research\research\SSVS\results\CFD_128_chAtt_plus_usseg_1\test_14\predicts', path_gt=r'C:\Users\yvona\Documents\NPU_research\research\SSVS\datasets\CFD_128_128\testA', log_file=r"C:\Users\yvona\Documents\NPU_research\research\SSVS\datasets\metu\log.txt" ):
  ...
  for pred_path in filepath_list:
               ...
               gt_path = str(gt_path0).replace(".png",".jpg")
               print(gt_path)

               y_pred = cv2.imread(str(pred_path),0)

               y_pred = y_pred.resize((128, 128))

               img0 = Image.open(gt_path)
               # img0 = numpy.array(img0)

               img = img0.resize((128,128))
